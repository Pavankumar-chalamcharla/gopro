...
class CapabilityEngine {
    ...
    fun classify(
        ...
        reasons += "NOTE: This is a PROVISIONAL classification from static capability scanning " +
            "only. No sensor-quality test (jitter/noise/bias), camera-stream quality test, or " +
            "gyro-camera synchronization test has run yet. Confirmed classification — and any " +
            "level above Basic — requires those measurements."
